	...
	private function get_empty_plugins_api_response( $response, $args ) {
		if ( is_wp_error( $response ) || property_exists( $response, 'error' )
			...
			$response     = array(
				...
				'short_description' => __( 'This required plugin does not support plugin dependencies. You will need to manually install this dependency. Please contact the plugin’s developer and ask them to add dependencies support and for information on how to install the this dependency.' ),
				'download_link'     => '',
				'banners'           => array(),
